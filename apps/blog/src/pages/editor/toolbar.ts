...
export function setupToolbar(textarea: HTMLTextAreaElement, root: ParentNode): void {
  root.querySelector(".admin-toolbar")?.addEventListener("click", (e) => {
    ...
    switch (action) {
      ...
      case "codeblock":
        ...
        break;
      case "image":
        insertAtCursor(textarea, "![alt](/images/)");
        break;
      case "ul":
        wrapSelection(textarea, "\n- ", "\n");
        break;
