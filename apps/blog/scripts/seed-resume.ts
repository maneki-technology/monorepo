...
const meta = JSON.stringify({
  ...
  links: [
    { label: "kien@maneki.tech", href: "mailto:kien@maneki.tech" },
    { label: "GitHub", href: "https://github.com/kiennt23" },
    { label: "LinkedIn", href: "https://linkedin.com/in/kiennt23" },
  ],
  skills: {
    "System Design": [
      "Microservices",
    ...
    "Distributed Systems": ["Kafka", "Redis", "Elasticsearch", "PostgreSQL", "SQL & NoSQL"],
    Languages: ["Go", "TypeScript", "Java", "Python"],
  },
});

const content = `Senior Software Engineer with 14+ years of hands-on experience across the full stack. Polyglot engineer (Go, TypeScript, Java, Python) specializing in distributed systems, micro-frontend architecture, and fine-grained authorization.
...
await db.execute({
  ...
  args: ["resume", title, content, meta],
});
